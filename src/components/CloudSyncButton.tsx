...
export function CloudSyncButton({
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute top-full mt-2 right-0 bg-white border border-gray-200 rounded-xl shadow-lg py-2 min-w-[140px] z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
        <button
