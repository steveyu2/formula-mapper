...
## 更新摘要
**变更内容**
- 新增国际化文档系统支持（README.md 和 README_zh.md 双语文档）
- 更新项目架构概览以反映整体架构的稳定性
- 增强技术栈介绍以体现现代化开发实践
- 完善项目结构说明以涵盖完整的文件组织
...
项目采用了完善的国际化文档支持，确保全球用户都能获得最佳的使用体验：
...
graph TB
subgraph "国际化文档系统"
README_EN[README.md - 英文版]
README_ZH[README_zh.md - 中文版]
README_EN --> LINK[文档链接]
README_ZH --> LINK
LINK --> FOOTER[页脚链接]
END
...
- [README_zh.md:95-96](file://README_zh.md#L95-L96)

### 双语文档特色

1. **内容一致性**：两份文档涵盖相同的功能介绍和技术说明
2. **本地化优化**：中文文档针对中文用户的使用习惯进行了优化
3. **技术术语统一**：确保技术术语在两种语言版本中的一致性
4. **示例完整性**：提供完整的使用示例和项目结构说明
...
- [src/components/ASTTree.tsx:1-191](file://src/components/ASTTree.tsx#L1-L191)
...
该项目为公式变量映射和可视化提供了一个坚实的技术基础，具有良好的扩展性和实用性，能够满足不同用户群体的需求。新增的国际化文档系统进一步提升了项目的全球可达性和用户体验。